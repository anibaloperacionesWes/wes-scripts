...
Excluye el nodo "Raimundo Tupper" (000021-03).
"""
...
NODO_EXCLUIDO = "000021-03"  # Raimundo Tupper
...
def obtener_nodos_cduc() -> list:
    """
    Obtiene todos los nodos de CDUC excepto Raimundo Tupper.
    ...
    # Filtrar excluyendo Raimundo Tupper
    nodos_incluidos = [
        node_id for node_id, node_name in nodos_cduc.items()
        if node_id != NODO_EXCLUIDO
    ]
...
def main():
    ...
    print("  (Desde archivos guardados, excluyendo Raimundo Tupper)")
    print("=" * 60)
    print()
    ...
    # Obtener nodos (excluyendo Raimundo Tupper)
    print("[2/3] Obteniendo nodos de CDUC (excluyendo Raimundo Tupper)...")
    ...
    print(f"[INFO] Nodo excluido: {NODO_EXCLUIDO} (Raimundo Tupper)")
