"""
Envía 4 correos separados (PDF) — CORMUP/Peñalolén, Puente Alto, La Florida, La Reina — junio 2026.
Destinatarios: Juan, Diego, Aníbal.

Uso:
  python enviar_agregados_junio2026_colegios_pdf_equipo.py
"""
...
ENVIOS = [
    (
        ...
        f"Reporte_Agregado_CORMUP_{SUFIJO}.docx",
        "CORMUP Peñalolén — Reporte agregado PDF — Junio 2026",
        "Adjunto el reporte agregado (PDF) de los colegios CORMUP / Peñalolén "
        "(14 establecimientos) para el periodo 01/06/2026 al 30/06/2026.\n",
    ),
    (
        ROOT / "reports" / "Corporación_Puente_Alto" / "ABREGADO",
        f"Reporte_Agregado_Corporación_Puente_Alto_{SUFIJO}.docx",
        "Puente Alto — Reporte agregado PDF — Junio 2026",
        "Adjunto el reporte agregado (PDF) de los colegios de Corporación Puente Alto "
        "(11 establecimientos) para el periodo 01/06/2026 al 30/06/2026.\n",
    ),
    (
    ...
    (
        ...
        "La Reina — Reporte agregado PDF — Junio 2026",
...
def main() -> int:
    ...
    print(f"\n[OK] 4 correos enviados. Para: {', '.join(TO_VISIBLE)}")
    return 0
