"""Enviar por correo el PDF del agregado Club Providencia (abril 2026).

Adjunta el PDF ya generado en:
reports/Club_Providencia/ABREGADO/AGREGADO_*/Reporte_Agregado_Club_Providencia_20260401_20260430.pdf
"""
...
PDF_PATH = (
    ...
    / "Club_Providencia"
    / "ABREGADO"
    / "AGREGADO_20260506_1402"
    / "Reporte_Agregado_Club_Providencia_20260401_20260430.pdf"
)
...
def main() -> None:
    ...
    msg["Subject"] = "Club Providencia — Reporte agregado PDF — Abril 2026"
    msg.attach(
        MIMEText(
            "Estimados Aníbal, Juan y Diego,\n\n"
            "Adjunto el reporte agregado (PDF) de Club Providencia para el periodo 01/04/2026 al 30/04/2026.\n\n"
            "Saludos cordiales,\n"
            "Sistema WES\n",
            "plain",
            "utf-8",
