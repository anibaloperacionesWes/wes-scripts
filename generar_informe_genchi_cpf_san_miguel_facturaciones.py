"""
Informe comparativo facturaciones Aguas Andinas — CPF San Miguel (Genchi / Gendarmería).

Estructura:
  reports/Genchi/CPF San Miguel/Facturaciones/
  reports/Genchi/CPF San Miguel/informe/

Ventana de análisis: ene-2025 a la fecha.
Excluye factura 8428005 (feb-2025, equipos off por licitación) y mes 2025-02 del desglose.

Uso:
  python generar_informe_genchi_cpf_san_miguel_facturaciones.py
"""
...
SITE_DIR = ROOT / "reports" / "Genchi" / "CPF San Miguel"
FACTURAS_DIR = next(
...
FECHA_RETIRO_WES = date(2025, 7, 2)
FECHA_FIN_CON_WES = date(2025, 7, 1)
FACTURA_EXCLUIDA = "8428005"
MESES_EXCLUIDOS = {"2025-02"}
MESES_PROYECCION_ANUAL = 12

CUENTA = "1008398-2"
MEDIDOR = "119758364"
CLIENTE = "Gendarmería de Chile — CPF San Miguel (Unidad Genchi)"
...
def main() -> int:
    ...
    csv_mes = OUT_BASE / f"facturaciones_genchi_cpf_mensual_{ts}.csv"
    ...
    csv_path = OUT_BASE / f"facturaciones_genchi_cpf_{ts}.csv"
    ...
    docx = OUT_BASE / f"Informe_Genchi_CPF_San_Miguel_facturaciones_{ts}.docx"
