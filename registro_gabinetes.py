...
GABINETES: List[Dict[str, object]] = [
    ...
    },
    {
        ...
        "notas": "CUR Anillo Sur y CUR Anillo Norte en el mismo gabinete.",
    },
    {
        "id": "PA-PAK-ANDEN",
        ...
        "confianza": "confirmado",
        "notas": "Tres impulsiones Andén 3-4: Matriz, Locales Gast. y Restaurante.",
    },
    {
        "id": "PA-PAK-DL",
        "nombre": "Parque Arauco Kennedy — Distrito de lujo",
        "nodos": ["000025-27", "000025-35", "000025-36"],
        "confianza": "confirmado",
        "notas": "Distrito de lujo DL, PAK BAZAR GOURMET y PAK DL KENNEDY en el mismo gabinete.",
    },
    {
        "id": "PA-PAK-PILETA",
