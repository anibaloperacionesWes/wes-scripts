"""
Envía 3 correos separados (PDF) — Intermodal, AGUNSA Lampa, COPEC mayo 2026.
...
# Carpetas exactas de la generación mayo 2026 (mismo nombre de .docx en AGUNSA).
ENVIOS = [
    (
        ROOT / "reports" / "AGUNSA" / "ABREGADO" / "AGREGADO_20260529_1841",
        "Reporte_Agregado_AGUNSA_20260501_20260531.docx",
        "AGUNSA Intermodal San Antonio — Reporte agregado PDF — Mayo 2026",
        "Adjunto el reporte agregado (PDF) de AGUNSA — Intermodal San Antonio "
        "para el periodo 01/05/2026 al 31/05/2026.\n",
    ),
    (
        ROOT / "reports" / "AGUNSA" / "ABREGADO" / "AGREGADO_20260529_1842",
        "Reporte_Agregado_AGUNSA_20260501_20260531.docx",
        "AGUNSA Lampa — Reporte agregado PDF — Mayo 2026",
        "Adjunto el reporte agregado (PDF) de AGUNSA Lampa (Depósito + módulos D, ABC y E) "
        "para el periodo 01/05/2026 al 31/05/2026.\n",
    ),
    (
        ROOT / "reports" / "COPEC" / "ABREGADO" / "AGREGADO_20260529_1848",
        "Reporte_Agregado_COPEC_20260501_20260531.docx",
        "COPEC — Reporte agregado PDF — Mayo 2026",
