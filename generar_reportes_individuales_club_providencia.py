"""
Script para generar reportes individuales de Club Providencia
Período: 01-01-2026 al 30-01-2026
"""
...
def get_club_providencia_nodes(company_id: str) -> list:
    """Obtiene todos los nodos de Club Providencia."""
...
def main():
    print("=" * 70)
    print("  GENERACIÓN DE REPORTES - CLUB PROVIDENCIA")
    ...
    try:
        ...
        company_name = "Club Providencia"
    print()
    
    # Obtener todos los nodos
    print("[1/2] Obteniendo nodos de Club Providencia...")
    nodes = get_club_providencia_nodes(COMPANY_ID)
    
    if not nodes:
        print("[ERROR] No se encontraron nodos de Club Providencia.")
