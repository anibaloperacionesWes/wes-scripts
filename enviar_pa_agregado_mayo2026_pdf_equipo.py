"""
PDF del agregado Corporación Puente Alto mayo 2026 → Juan, Diego, Aníbal; BCC José.
"""
...
DOCX_GLOB = f"Reporte_Agregado_Corporación_Puente_Alto_{PERIODO_SUFIJO}.docx"
...
def _ultimo_docx() -> Path:
    base = ROOT / "reports" / "Corporación_Puente_Alto" / "ABREGADO"
...
def main() -> int:
    ...
    msg["Subject"] = "Puente Alto — Reporte agregado PDF — Mayo 2026"
    msg.attach(
        MIMEText(
