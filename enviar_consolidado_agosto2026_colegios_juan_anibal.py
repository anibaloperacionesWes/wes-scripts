...
CLIENTES = [
    (
        ...
        "Reporte_Agregado_*_20260801_20260828.pdf",
        "01/08/2026 al 28/08/2026 — Lo Velásquez, Cumbre Pte., ICCO",
    ),
    (
        "La Florida",
        ROOT / "reports" / "La_Florida" / "ABREGADO",
        "Reporte_Agregado_*_20260801_20260828.pdf",
        "01/08/2026 al 28/08/2026 — Liceo Alto Cordillera",
    ),
    (
        "La Reina",
        ROOT / "reports" / "La_Reina" / "ABREGADO",
        "Reporte_Agregado_*_20260805_20260828.pdf",
        "05/08/2026 al 28/08/2026 — Eugenio María De Hostos "
    ...
    (
        ...
        "Reporte_Agregado_*_20260801_20260828.pdf",
        "01/08/2026 al 28/08/2026 — 14 establecimientos",
    ),
]
