"""
Script para generar solo reportes individuales de La Reina (sin presentación)
...
# Configuración
COMPANY_ID = "000024"  # La Reina
START_DATE = "01/01/2026"
END_DATE = "31/01/2026"

def get_la_reina_nodes(company_id: str) -> list:
    """Obtiene todos los nodos de La Reina."""
...
def main():
    print("=" * 70)
    print("  GENERACIÓN DE REPORTES INDIVIDUALES - LA REINA")
    ...
    try:
        ...
        company_name = "La Reina"
    print()
    
    # Obtener todos los nodos
    print("[1/2] Obteniendo nodos de La Reina...")
    nodes = get_la_reina_nodes(COMPANY_ID)
    
    if not nodes:
        print("[ERROR] No se encontraron nodos de La Reina.")
