"""Script para generar todos los reportes de BUPA desde el 03 de octubre hasta hoy."""
...
def preguntar_fuente_agua():
    """Pregunta si existe una fuente de agua."""
    print()
    print("=" * 70)
    ...
    print()
    print("Para BUPA, normalmente todos los puntos son consumidores independientes.")
    print()
    
    respuesta = input("¿Tiene fuente de agua? (s/n, por defecto n): ").strip().lower()
...
def main():
    ...
    fuente_id = preguntar_fuente_agua()
