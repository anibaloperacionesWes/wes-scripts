...
de Fundo Zapallar para el mes de diciembre 2025.
...
def main():
    print("=" * 60)
    print("  GENERACIÓN DE REPORTES FUNDO ZAPALLAR - DICIEMBRE 2025")
    print("=" * 60)
    print()
    ...
    try:
        ...
        aggregated_report_path = generate_aggregated_report(
            ...
            end_date=END_DATE,
            output_dir="reports",
            fuente_agua_id="000027-01"  # Matriz ESVAL para Fundo Zapallar
        )
