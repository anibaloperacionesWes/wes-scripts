"""Envía por correo el PDF del agregado Providencia (marzo 2026) a Juan y Aníbal."""
...
PDF_PATH = (
    ...
    / "Providencia"
    / "ABREGADO"
    / "AGREGADO_20260507_1533"
    / "Reporte_Agregado_Providencia_20260301_20260331.pdf"
)
...
def main() -> None:
    ...
    msg["Subject"] = "Providencia — Reporte agregado PDF — Marzo 2026"
    msg.attach(
        MIMEText(
            "Estimados Juan y Aníbal,\n\n"
            "Adjunto el reporte agregado (PDF) de Providencia para el periodo 01/03/2026 al 31/03/2026.\n\n"
            "Saludos cordiales,\n"
            "Sistema WES\n",
            "plain",
            "utf-8",
