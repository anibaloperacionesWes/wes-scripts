"""Convierte a PDF el agregado UDD abril 2026 (más reciente) y lo envía a Aníbal, Juan y Diego."""
...
ABREGADO = ROOT / "reports" / "UDD" / "ABREGADO"
AGG_PATTERN = "Reporte_Agregado_UDD_20260401_20260430.docx"
...
def main() -> None:
    ...
    msg["Subject"] = "UDD — Reporte agregado PDF — Abril 2026"
    msg.attach(
        MIMEText(
            "Estimados Aníbal, Juan y Diego,\n\n"
            "Adjunto el reporte agregado (PDF) de UDD para el período del 01/04/2026 al 30/04/2026.\n\n"
            "Saludos cordiales,\n"
            "Sistema WES\n",
            "plain",
            "utf-8",
