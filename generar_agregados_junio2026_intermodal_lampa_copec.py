"""Agregados junio 2026: AGUNSA Intermodal, AGUNSA Lampa y COPEC."""
...
def _generar(label: str, cid: str, nids: list[str]) -> None:
    ...
    print(f"[INFO] Periodo: {PERIODO[0]} – {PERIODO[1]}")
...
def main() -> None:
    print("GENERACIÓN AGREGADOS JUNIO 2026 — Intermodal, Lampa, COPEC\n")
