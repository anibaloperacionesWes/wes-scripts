"""
Script para generar reporte del nodo Baños del Mall Curauma de Parque Arauco
desde 12 de diciembre a 31 de diciembre 2025.
"""
...
NODE_ID = "000025-16"  # Baños (Curauma)
...
def generar_reporte(node_id: str):
    """
    Genera el reporte individual para el nodo Baños de Curauma.
    """
...
def enviar_reporte_por_correo(reporte_path: Path, node_id: str, node_name: str):
    ...
    try:
        ...
        # Crear asunto
        asunto = f"Reporte - Parque Arauco Curauma {node_name} - Diciembre 2025"
        msg["Subject"] = asunto
...
Se adjunta el reporte de consumo y fugas generado para el nodo {node_name} del Mall Curauma de {company_name}.
        ...
        if pdf_path and pdf_path.exists():
            ...
            with open(pdf_path, "rb") as f:
                ...
                adjunto.add_header(
                    "Content-Disposition",
                    "attachment",
                    filename=f"Reporte_Parque_Arauco_Curauma_{nombre_archivo}_Diciembre_2025.pdf"
                )
                msg.attach(adjunto)
            ...
            with open(reporte_path, "rb") as f:
                ...
                adjunto.add_header(
                    "Content-Disposition",
                    "attachment",
                    filename=f"Reporte_Parque_Arauco_Curauma_{nombre_archivo}_Diciembre_2025.docx"
                )
                msg.attach(adjunto)
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Genera reporte de Baños - Mall Curauma")
    ...
    print("=" * 70)
    print("  GENERACION DE REPORTE: PARQUE ARAUCO - CURAuma - BAÑOS")
    print("=" * 70)
    print("")
