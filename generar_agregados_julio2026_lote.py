"""
Agregados julio 2026 — lote solicitado:

  Fundo Zapallar, DERCO, Nido de Águilas, Lo Valledor,
  UDD, Club Providencia, AGUNSA (Lampa + Intermodal).

Formato: mismo que generar_agregados_junio2026_lote8 / clientes_batch
(generate_aggregated_report, sin PPT, fetch paralelo).

Uso:
  python generar_agregados_julio2026_lote.py
"""
...
# Julio 2026 hasta el día de corrida (mes en curso)
PERIODO = ("01/07/2026", "28/07/2026")
...
def main() -> None:
    ...
    print("GENERACIÓN AGREGADOS JULIO 2026 — LOTE SOLICITADO\n")
    print(f"Periodo: {PERIODO[0]} – {PERIODO[1]}\n")
    ok = 0
    errors: list[str] = []
