"""Script para generar todos los reportes individuales y agregado de BUPA desde 15 de octubre al 15 de diciembre."""
...
# Periodo: 15 de octubre al 15 de diciembre
...
def main():
    print("=" * 70)
    print("GENERANDO REPORTES DE BUPA - OCTUBRE A DICIEMBRE")
    print("=" * 70)
